...
- Build: `g++ main.cpp -lncurses -Iinclude -Iinclude/CampbellLib -o data/MazeMaster.o include/Maze.cpp include/Menu.cpp include/Game.cpp include/Callbacks.cpp include/CampbellLib/CampbellLib.cc`  
- Run: `./data/MazeMaster.o`  
...
## Input/Output
### [Game.cpp] lines [72-80](/include/Game.cpp#L72-L80)  
...
### [Maze.cpp] lines [161-206](/include/Maze.cpp#L161-L206), [601-633](/include/Maze.cpp#L601-L633)  
...
### [Menu.cpp] lines [17-87](/include/Menu.cpp#L17-L87), [114-146](/include/Menu.cpp#L114-L146), [221-258](/include/Menu.cpp#L221-L258)  
...
### [CampbellLib.cc] lines [79-83](/include/CampbellLib/CampbellLib.cc#L79-L83)  
...
## Control Flow
### [Game.cpp] lines [71-87](/include/Game.cpp#L71-L87)  
Control flow is modified based on the user inputs and state of the filesystem.

### [Maze.cpp] lines [45-89](/include/Maze.cpp#L45-L89)  
...
### [Menu.cpp] lines [17-64](/include/Menu.cpp#L17-L64)  
The menu array is iterated through in order to print each option to the screen.

### [Callbacks.cpp] lines [47-121](/include/Callbacks.cpp#L47-L121)  
...
### [Maze.h] lines [7-164](/include/Maze.h#L7-L164)  
A maze is a matrix of TileData which is an enum of different possible tiles in the maze. This is because a maze is a 2D grid of data and can be represented as either `EMPTY` or a `WALL`. Other values are for generating the maze, file I/O, and determining the start and end of the maze. The symbols displayed on the screen are a struct of chars to store each character in an easily accessible unit. Possible input options are also stored in an enum.

### [Menu.h] lines [8-171](/include/Menu.h#L8-L171)  
...
## Function
### [Callbacks.cpp] lines [10-153](/include/Callbacks.cpp#L10-L153); [Callbacks.h] lines [4-36](/include/Callbacks.h#L4-L36)  
All menu callbacks are defined here. All functions return an integer and take no arguments due to the implementation requirements declared in Menu.

### [Maze.cpp] lines [21-633](/include/Maze.cpp#L21-L633); [Maze.h] lines [32-164](/include/Maze.h#L32-L164)  
Maze control, generation, solving, fault-checking, helper-functions, file I/O, and user I/O is managed here.

### [Menu.cpp] lines [4-266](/include/Menu.cpp#L4-L266); [Menu.h] lines [20-170](/include/Menu.h#L20-L170)  
Menu control, helper-functions, user I/O and option generating is managed here.

### [Game.cpp] lines [15-106](/include/Game.cpp#L15-L106); [Game.h] lines [16-59](/include/Game.h#L16-L59)  
Overall manager of menu and maze controllers as well as overwatch over execution state and control flow take place here.

### [CampbellLib.cc] lines [5-83](/include/CampbellLib/CampbellLib.cc#L5-L83); [CampbellLib.h] lines [9-96](/include/CampbellLib/CampbellLib.h#L9-L96)  
A collection of helper-functions that I use often and found helpful across multiple projects.

## File IO
### [Game.cpp] lines [69-89](/include/Game.cpp#L69-L89)  
`saves/lastsession.dat` is checked to see if it exists.

### [Maze.cpp] lines [98-160](/include/Maze.cpp#L98-L160)  
...
[Maze.cpp]: /include/Maze.cpp
[Maze.h]: /include/Maze.h
[Titles.cpp]: /include/Titles.cpp
[Titles.h]: /include/Titles.h
[Callbacks.cpp]: /include/Callbacks.cpp
[Callbacks.h]: /include/Callbacks.h
[CampbellLib.cc]: /include/CampbellLib/CampbellLib.cc
[CampbellLib.h]: /include/CampbellLib/CampbellLib.h
[main.cpp]: /main.cpp
