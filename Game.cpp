...
void GameController::Initialize(int /*argc*/, const char** /*argv[]*/) {
  ...
  // Main Menu
  menu_.addOption(
      Menu::MenuController::Option("Easy", &Callbacks::playEasy, true, true));
  menu_.addOption(
      Menu::MenuController::Option("Medium", &Callbacks::playMedium));
  menu_.addOption(Menu::MenuController::Option("Hard", &Callbacks::playHard));
  menu_.addOption(
      Menu::MenuController::Option("Custom", &Callbacks::playCustom));
  ...
  menu_.addOption(
      Menu::MenuController::Option("Load Maze", &Callbacks::loadButton));
  menu_.addOption(Menu::MenuController::Option(
      "----------", &Callbacks::nothing, false, false));
  menu_.addOption(Menu::MenuController::Option("Quit", &Callbacks::ExitApp_));

  // Custom Maze Menu
  customMenu_.addOption(
      Menu::MenuController::Option("Rows:", &Callbacks::nothing, false, false));
  rowOptionIndex_ = customMenu_.getOptionList().size();
  customMenu_.addOption(
      Menu::MenuController::Option(20, &Callbacks::updateConfirm, true, true));
  customMenu_.addOption(Menu::MenuController::Option(
      "Columns:", &Callbacks::nothing, false, false));
  colOptionIndex_ = customMenu_.getOptionList().size();
  customMenu_.addOption(
      Menu::MenuController::Option(20, &Callbacks::updateConfirm));
  confirmOptionIndex_ = customMenu_.getOptionList().size();
  customMenu_.addOption(
      Menu::MenuController::Option("Confirm", &Callbacks::customButton));
  customMenu_.addOption(Menu::MenuController::Option(
      "----------", &Callbacks::nothing, false, false));
  customMenu_.addOption(
      Menu::MenuController::Option("Back", &Callbacks::closeSubMenu));
  ...
  saveMenu_.addOption(Menu::MenuController::Option(
      "Filename:", &Callbacks::nothing, false, false));
  filenameOptionIndex_ = saveMenu_.getOptionList().size();
  saveMenu_.addOption(Menu::MenuController::Option(true, true))
      ->modifyableText = "MyMaze.dat";
  saveSettingsOptionIndex_ = saveMenu_.getOptionList().size();
  saveMenu_.addOption(Menu::MenuController::Option("Remove", saveOptions));
  saveMenu_.addOption(
      Menu::MenuController::Option("Confirm", &Callbacks::filenameButton));
  saveMenu_.addOption(Menu::MenuController::Option(
      "----------", &Callbacks::nothing, false, false));
  saveMenu_.addOption(
      Menu::MenuController::Option("Back", &Callbacks::closeSubMenu));
